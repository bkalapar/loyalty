...
@NamedQueries({
  ...
  @NamedQuery(name = "Transaction.groupCategoriesForUser", query = "SELECT t.category, COUNT (t.transactionId) FROM Transaction t WHERE t.userId = :userId GROUP BY t.category")
})
@Getter @Setter
